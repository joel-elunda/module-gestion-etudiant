...
const Filiere = () => {
    ...
    const Supp = (id) => {
        if (window.confirm('voulez-vous supprimer?')) {
            fetch('https://warren.pythonanywhere.com/api/filieres/' + id, {
                method: 'DELETE'
            })
                .then((res) => {
    ...
    const [fil, fildatachange] = useState(null);
    ...
    const onAdd = async (nom, description) => {
        await fetch('https://warren.pythonanywhere.com/api/filieres/', {
            method: 'POST',
            body: JSON.stringify({
                nom: nom,
                                ...
                                {fil &&
                                    fil.map((item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td>
                                                <button className="btn btn-success mr-2">Modifier</button>
